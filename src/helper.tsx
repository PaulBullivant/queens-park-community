...
export class Urls {
    public static  SignUp = 'https://docs.google.com/forms/d/e/1FAIpQLScJpHQ2sVjTQyvx_ysCsuBIykouZsfMumQlKgzbOa8Zuoh3LA/viewform?usp=sf_link';
    public static  GitHub = 'https://github.com/PaulBullivant/queens-park-community';
    public static  Code = 'code';
    public static  HowItWorks = 'code';
